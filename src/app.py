...
from model.query_generator import (
    query_generator,
)  # Importa a função de geração de query
from database.query_handler import (
    query_handler,
)  # Importa a função para execução da consulta no banco
